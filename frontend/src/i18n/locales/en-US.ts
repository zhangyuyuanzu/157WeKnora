export default {
  ...
  knowledgePush: {
    title: 'Knowledge Push',
    subtitle: 'Select a knowledge base and send update notifications to specified recipients',
    // Step 1
    selectSpace: 'Select Space',
    selectKB: 'Select Knowledge Base',
    myKnowledgeBases: 'My Knowledge Bases',
    sharedSpaces: 'Shared Spaces',
    noSpaces: 'No accessible shared spaces',
    noKBInSpace: 'No knowledge bases in this space',
    noMyKB: 'No personal knowledge bases',
    selectedKB: 'Selected Knowledge Base',
    ...
    kbDocCount: '{count} document(s)',
    kbChunkCount: '{count} chunk(s)',
    // Step 2
    recipients: 'Recipients',
    recipientPlaceholder: 'Enter email address, press Enter to add',
    addRecipient: 'Add',
    recipientTip: 'Supports multiple emails separated by commas, semicolons, or spaces',
    searchUsers: 'Search Platform Users',
    searchUsersPlaceholder: 'Search by username or email...',
    noUsersFound: 'No matching users found',
    sendToAllMembers: 'Send to All Space Members',
    sendToAllMembersTip: 'Send notification to all {count} members of "{name}"',
    allMembersAdded: 'Added all members\' emails from this space',
    membersAddedCount: 'Added {count} member email(s)',
    invalidEmail: "'{email}' is not a valid email address",
    duplicateEmail: 'This email has already been added',
    recipientRequired: 'Please add at least one recipient',
    loadMembersFailed: 'Failed to load space members',
    selectedCount: '{count} recipient(s) selected',
    // Step 3
    message: 'Notification Message',
    messagePlaceholder: 'Enter your message, e.g., The knowledge base has been updated, please review',
    messageRequired: 'Please enter a notification message',
    updateSummary: 'Update Summary',
    updateSummaryPlaceholder: 'Briefly describe what was updated',
    optional: 'optional',
    // Actions
    send: 'Send Notification',
    sending: 'Sending...',
    ...
    kbRequired: 'Please select a knowledge base first',
    // UI
    step1: 'Select Knowledge Base',
